...
- `setup.sh`: sets up a Mac. Installs git, Homebrew, Node, VS Code, the GitHub tool, Claude Code and Codex if missing, creates `.env`, runs the check. Run `bash Tools/setup.sh`. Add `--check` to only report.
